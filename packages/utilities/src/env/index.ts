...
export const env = createEnv({
  server: {
    ...
    CF_R2_ENDPOINT: z.string().optional().default(""),
    CF_R2_ACCESS_KEY_ID: z.string().optional().default(""),
    CF_R2_SECRET_ACCESS_KEY: z.string().optional().default(""),
    CF_R2_BUCKET_NAME: z.string().optional().default(""),
    CF_R2_PUBLIC_DOMAIN: z.string().optional().default(""),
  },
  client: {
